...
class QuestionCollectionIdOnlyConsumer(AsyncJsonWebsocketConsumer):  
    @property
    def nome_do_grupo(self):
        return f"chats_collection_id_only_question"
...
class QuestionCollectionConsumer(AsyncJsonWebsocketConsumer):   
    
    @property
    def nome_do_grupo(self):
        return f"chats_collection_question"
...
class QuestionConsumer(AsyncJsonWebsocketConsumer):
    ...
    @property
    def nome_do_grupo(self):
        return f"Question_{self.object_pk}" 
    ...
    def can_view(self):
        ...
        try:
            ...
            records = Question.objects.filter(pk=self.object_pk, criado_por=user)
