...
class OrganizationCollectionIdOnlyConsumer(AsyncJsonWebsocketConsumer):  
    @property
    def nome_do_grupo(self):
        return f"organizations_collection_id_only_organization"
...
class OrganizationCollectionConsumer(AsyncJsonWebsocketConsumer):   
    
    @property
    def nome_do_grupo(self):
        return f"organizations_collection_organization"
...
class OrganizationConsumer(AsyncJsonWebsocketConsumer):
    ...
    @property
    def nome_do_grupo(self):
        return f"Organization_{self.object_pk}" 
    ...
    def can_view(self):
        ...
        try:
            ...
            records = Organization.objects.filter(pk=self.object_pk, criado_por=user)
